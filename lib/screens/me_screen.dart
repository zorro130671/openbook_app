      ...
      body: ListView(
        ...
        children: [
            ...
            children: [
              _QuickAction(
                ...
                onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => const MyStoriesPostsScreen(),
                  ),
                ),
              ),
              ...
              const SizedBox(width: 8),
              const _QuickAction(icon: Icons.folder_open, label: 'My Files'),
            ],
          ),
          ...
          _NavTile(
            ...
            label: 'Stories & Posts',
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => const MyStoriesPostsScreen()),
            ),
          ),
...
class _NavTile extends StatelessWidget {
  ...
  const _NavTile({required this.icon, required this.label, this.onTap});
...
class _MyQRSheet extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Big QR placeholder (swap to a real QR later if you like)
    return Padding(
      padding: const EdgeInsets.all(16),
      child: Column(
        mainAxisSize: MainAxisSize.min,
